...
public class OAuth24DClient : IDisposable
{
    ...
    public struct AuthCompletionData
    {
        ...
        /// <summary>
        /// The access token that grants our application permissions on behalf of a user
        /// </summary>
    ...
    /// <param name="clientImpl">optional http client implementation to use</param>
    public OAuth24DClient(string codeUri, string pollUri, HttpClient clientImpl = null)
    {
        ...
        this.client = clientImpl ==  null ? new HttpClient() : clientImpl;
    }
    ...
    private void PollTimer(object state)
    {
        ...
        this.client.GetAsync(baseUri.Uri).ContinueWith(async (Task<HttpResponseMessage> prev) =>
        {
            ...
            if (message.StatusCode == HttpStatusCode.OK)
            {
                ...
                eventData.access_token = obj.Value<string>("access_token");
